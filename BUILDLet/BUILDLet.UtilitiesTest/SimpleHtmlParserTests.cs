...
namespace BUILDLet.Utilities.Tests
{
    ...
    public class SimpleHtmlParserTests
    {
        ...
        public void SimpleHtmlParser_GetAttributesTest2()
        {
            ...
            string content = File.ReadAllText(Path.Combine(@"..\..\..\TestData\", testcases[0].filename), testcases[0].encoding);
        ...
        private void innerTest_SimpleHtmlParser(testcase[] testcases)
        {
            ...
            {
                string filepath = Path.Combine(@"..\..\..\TestData\", testcase.filename);
                string[] actual;
        ...
        {
            Log log = new Log();
            string content = File.ReadAllText(@"..\..\..\TestData\" + "comment.html");
